    ...
    public static Contacto crearContacto() {
        ...
        switch (opcion) {
            ...
            case 2:
                ...
                String puesto = utilities.leerString("Escribe el puesto del contacto: ");
                String telefonoEmpresa = utilities.leerString("Escribe el teléfono de la empresa del contacto: ");
                Contacto t = new Trabajo(nombre, apellido, telefono, email, direccion, cumpleaños, empresa, puesto, telefonoEmpresa);
                System.out.println("Contacto creado: " + t);
                return t;

            case 3:
                String Amigos = utilities.leerString("Escribe el conocido del contacto: ");
